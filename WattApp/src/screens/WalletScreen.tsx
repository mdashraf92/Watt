...
import type { CustomerStackParamList, WalletTransaction } from '../types';
...
export default function WalletScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <TouchableOpacity accessibilityRole="button" style={styles.paymentMethodsRow} onPress={() => navigation.navigate('MyPackages')}>
        <GiftIcon size={22} color={COLORS.primary} />
        <Text style={styles.paymentMethodsText}>{t.pkg_mine}</Text>
