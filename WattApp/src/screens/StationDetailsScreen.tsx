...
export default function StationDetailsScreen() {
  ...
  const packageVenue = !isListing && station.is_package_venue === true;
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsGrid}>
          <StatCard label={t.station_price} value={packageVenue ? t.pv_label : station.price_per_kwh.toFixed(3)} unit={packageVenue ? t.pv_included : "OMR/kWh"} color={COLORS.primary} emoji="💰" />
      ...
      <View style={styles.bookBar}>
        <View>
          <Text style={styles.bookPrice}>{packageVenue ? t.pv_label : `${station.price_per_kwh.toFixed(3)} OMR`}</Text>
          <Text style={styles.bookPriceUnit}>{packageVenue ? t.pv_included : "/kWh"}</Text>
        </View>
        <View style={{ flex: 1 }}>
          <GradientButton
